...
st_mask box --input "../target/sub-example_unshimmed_e1.nii.gz" --size 40 40 14 --output "../../derivatives/sub-example/sub-example_target_mask.nii.gz" || exit

# Shim
st_b0shim gradient-realtime --fmap "sub-example_fieldmap.nii.gz" --target "../target/sub-example_unshimmed_e1.nii.gz" --resp "${INPUT_PATH}/PMUresp_signal.resp" --mask-static "../../derivatives/sub-example/sub-example_target_mask.nii.gz" --mask-riro "../../derivatives/sub-example/sub-example_target_mask.nii.gz" --output "../../derivatives/sub-example/gradient_realtime" || exit
st_b0shim realtime-dynamic --fmap "sub-example_fieldmap.nii.gz" --target "../target/sub-example_unshimmed_e1.nii.gz" --mask-static "../../derivatives/sub-example/sub-example_target_mask.nii.gz" --mask-riro "../../derivatives/sub-example/sub-example_target_mask.nii.gz" --resp "${INPUT_PATH}/PMUresp_signal.resp" --scanner-coil-order '1' --output-file-format-scanner "gradient" --output "../../derivatives/sub-example/realtime" || exit
