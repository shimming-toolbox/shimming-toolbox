...
# Shim
st_realtime_shim -fmap "sub-example_fieldmap.nii.gz" -anat "../anat/sub-example_unshimmed_e1.nii.gz" -resp "../../../${1}/PMUresp_signal.resp" -mask "sub-example_anat_mask.nii.gz" -output "."|| exit
