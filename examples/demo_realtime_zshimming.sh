...
# Shim
st_realtime_zshim -fmap "sub-example_fieldmap.nii.gz" -anat "../anat/sub-example_unshimmed_e1.nii.gz" -resp "../../../realtime_zshimming_data/PMUresp_signal.resp" -mask_static "sub-example_anat_mask.nii.gz" -mask_riro "sub-example_anat_mask.nii.gz" -output "." || exit
