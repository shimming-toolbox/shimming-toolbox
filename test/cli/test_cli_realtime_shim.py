...
#
#         # import json
#         # fname_json = fname_fieldmap.rsplit('.nii', 1)[0] + '.json'
#         # with open(fname_json) as json_file:
#         #     json_data = json.load(json_file)
#         #
#         # orientation = json_data['ImageOrientationPatientDICOM']
#         # x_orient = orientation[:3]
#         # y_orient = orientation[3:]
#         # z_orient = np.cross(x_orient, y_orient)
#         # print(f"x: {x_orient}, y: {y_orient}, z: {z_orient}")
#
#         # Set up mask
#         # Cube
#         # static
