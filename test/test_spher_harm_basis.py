...
class TestGEBasis:
    def test_ge_basis(self, x, y, z):
        ...
        assert np.allclose(basis[:, :, 1, 4], np.array([[-2.00681342e-05, -1.00644870e-05, -2.00438658e-05],
                                                        [-9.99151300e-06, 0.00000000e+00, -9.99151300e-06],
                                                        [-2.00438658e-05, -1.00644870e-05, -2.00681342e-05]]))
        assert np.allclose(basis[1, :, :, 5], np.array([[1.009365e-07, 3.446500e-09, 3.974650e-08],
                                                        [6.689500e-08, 0.000000e+00, 6.689500e-08],
                                                        [3.974650e-08, 3.446500e-09, 1.009365e-07]]))
        assert np.allclose(basis[:, 1, :, 6], np.array([[1.0684125e-07, 6.6350750e-08, -6.5602750e-08],
                                                        [-4.5731500e-08, 0.0000000e+00, -4.5731500e-08],
                                                        [-6.5602750e-08, 6.6350750e-08, 1.0684125e-07]]))
        assert np.allclose(basis[:, :, 1, 7], np.array([[8.1380980e-08, 9.0716095e-06, 7.8257020e-08],
                                                        [-8.9917905e-06, 0.0000000e+00, -8.9917905e-06],
                                                        [7.8257020e-08, 9.0716095e-06, 8.1380980e-08]]))
        assert np.allclose(basis[1, 1, :, 8], [-1.49325e-09, 0.00000e+00, -1.49325e-09])
    ...
    def test_ge_basis_order2(self, x, y, z):
        ...
        assert (np.all(basis.shape == (x.shape[0], x.shape[1], x.shape[2], 5)))
        # xy, zy, zx, X2 - Y2, z2
        assert np.allclose(basis[:, :, 1, 0], np.array([[-2.00681342e-05, -1.00644870e-05, -2.00438658e-05],
                                                        [-9.99151300e-06, 0.00000000e+00, -9.99151300e-06],
                                                        [-2.00438658e-05, -1.00644870e-05, -2.00681342e-05]]))
        assert np.allclose(basis[1, :, :, 1], np.array([[1.009365e-07, 3.446500e-09, 3.974650e-08],
                                                        [6.689500e-08, 0.000000e+00, 6.689500e-08],
                                                        [3.974650e-08, 3.446500e-09, 1.009365e-07]]))
        assert np.allclose(basis[:, 1, :, 2], np.array([[1.0684125e-07, 6.6350750e-08, -6.5602750e-08],
                                                        [-4.5731500e-08, 0.0000000e+00, -4.5731500e-08],
                                                        [-6.5602750e-08, 6.6350750e-08, 1.0684125e-07]]))
        assert np.allclose(basis[:, :, 1, 3], np.array([[8.1380980e-08, 9.0716095e-06, 7.8257020e-08],
                                                        [-8.9917905e-06, 0.0000000e+00, -8.9917905e-06],
                                                        [7.8257020e-08, 9.0716095e-06, 8.1380980e-08]]))
        assert np.allclose(basis[1, 1, :, 4], [-1.49325e-09, 0.00000e+00, -1.49325e-09])
