...
@click.option('-X', 'x_position', type=click.FLOAT, help="scanner's X position in mm [optional]")
@click.option('-Y', 'y_position', type=click.FLOAT, help="scanner's Y position in mm [optional]")
