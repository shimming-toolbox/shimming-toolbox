...
class TestImageConcat(object):
    def setup_method(self):
        path_target = os.path.join(__dir_testing__, 'ds_b0', 'sub-realtime', 'anat')
        self.list_fname = [os.path.join(path_target, 'sub-realtime_unshimmed_e1.nii.gz'),
                           os.path.join(path_target, 'sub-realtime_unshimmed_e2.nii.gz'),
                           os.path.join(path_target, 'sub-realtime_unshimmed_e3.nii.gz')]
